...
\draw[decorate,decoration={snake,amplitude=.4mm,segment length=1.5mm,post length=0mm}, very thick, color = black](02.0967,-00.2500) -- ( 03.5300,-00.2500);
\node (Point) at (02.1467, 0){};  \node (Label) at (0.5,-00.4500){\scriptsize{Local}}; \draw (Point) |- (Label);
\node (Point) at (03.4800, 0){};  \node (Label) at (4.5,-00.4500){\scriptsize{Global}}; \draw (Point) |- (Label);
\node (Point) at (02.3733, 0){};  \node (Label) at (4.5,-00.7500){\scriptsize{GA}}; \draw (Point) |- (Label);
\end{tikzpicture}
\caption{MSE-RF-input.property}
\label{fig:}
\end{figure}
