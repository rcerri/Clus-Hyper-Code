...
public class FullRanking {
	...
	public static void main(String[] args) throws IOException, ClusException {
	       ...
	       if (args.length != 6) {
	            System.err.println("The number of parameters is 5:  <training dataset> <test dataset> <attributes> <numOutputs> <classification|regression> <dt|rf>");
	            System.exit(1);
	        }
	        ...
	        if(classification)
	        	System.out.println("Partitions, AUCROC train, AUCROC test, AUPRC train, AUPRC test ");
	        else
	        	System.out.println("Partitions, MAE train, MAE test, MSE train, MSE test ");
        	...
        	System.out.print("["+printPartition(global)+"],");
	        ...
	        System.out.print("["+printPartition(local)+"],");
