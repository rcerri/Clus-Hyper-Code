...
import Util.Fichero;
//import Util.ClusWrapper.NullOutputStream;
 ...
 *
 */
public class ClusWrapperNonStatic {
	...
	private InputStream createInputStreamBaseConfigFile(String target, boolean trainErrors) throws IOException{
    ...
    private InputStream createInputStreamBaseConfigFileForClassification(String target, boolean trainErrors) throws IOException{
...
*/
	 ...
	 */
	public Double[][][] processOutputRegression(boolean train){
	...
	public Double[][][] processOutputClassification(boolean train){
	...
	public myMeasures evaluateIndividual(int individual [], boolean train) throws IOException, ClusException{
		...
		for (int j=0; j<MaxClassifiers;j++){
			...
			if(!Classifier[j].equals("")){
				...
				if(PreviousSolutions.containsKey(Classifier[j])){ // if this is already in the HashTable:
					...
					System.out.println("HashSize: "+PreviousSolutions.size());
	...
	public myMeasures evaluateIndividualClassification(int individual [], boolean train) throws IOException, ClusException{
