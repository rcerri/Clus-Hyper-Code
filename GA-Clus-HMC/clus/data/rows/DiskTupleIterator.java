...
public class DiskTupleIterator extends FileTupleIterator {
	...
	protected boolean m_Nofile;
	protected String m_datos;
	...
	public DiskTupleIterator(String data, ClusSchemaInitializer init, DataPreprocs procs, Settings sett, boolean NoFile) {
		super(procs);
		m_File = null;
		m_datos = data;
		m_Init = init;
	...
	public void init() throws IOException, ClusException {
		...
		if(m_Nofile)
			m_Reader = new ClusReader(m_datos, m_Sett,m_Nofile);
		else
