 ...
 ***********************************************************************/
	...
	// added by celine for semi-supervised learning (April 2015)
	// currently only affects singleRun(Main) in Clus.java
	public boolean isWriteOutFile() {
		return m_WriteOutFile.getValue();
	}
