...
import headDt.topDown.SimpleCart;
import weka.classifiers.Evaluation;
import weka.core.Instances;

public class GenerateCARTResults {

	public GenerateCARTResults(String source,String resultado) throws Exception{
		new DadosEntrada();
		...
		String outFileName = new String(resultado + "CART.csv");
