...
public class GenerateJ48Results {

	public GenerateJ48Results(String source, String resultado) throws Exception{
		...
		String outFileName = new String(resultado + "C4.5.csv");
