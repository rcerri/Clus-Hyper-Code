...
public class Evaluation implements Serializable, Summarizable, RevisionHandler {
  ...
  /**
   * Calculates the 'regular' average AUC.
   * 
   * @return the average AUC.
   */
  public double averageAreaUnderROC() {
    return m_delegate.averageAreaUnderROC();
  }
  ...
  /**
   * Calculates the 'regular' average true positive rate.
   * 
   * @return the average true positive rate.
   */
  public double averageTruePositiveRate() {
    return m_delegate.averageTruePositiveRate();
  }
  ...
  /**
   * Calculates the 'regular' average true negative rate.
   * 
   * @return the average true negative rate.
   */
  public double averageTrueNegativeRate() {
    return m_delegate.averageTrueNegativeRate();
  }
  ...
  /**
   * Calculates the 'regular' average false positive rate.
   * 
   * @return the average false positive rate.
   */
  public double averageFalsePositiveRate() {
    return m_delegate.averageFalsePositiveRate();
  }
  ...
  /**
   * Calculates the 'regular' average recall.
   * 
   * @return the average recall.
   */
  public double averageRecall() {
    return m_delegate.averageRecall();
  }
  ...
  /**
   * Calculates the 'regular' average precision.
   * 
   * @return the average precision.
   */
  public double averagePrecision() {
    return m_delegate.averagePrecision();
  }
  ...
  /**
   * Calculates the 'regular' average F-Measure.
   * 
   * @return the average F-Measure.
   */
  public double averageFMeasure() {
    return m_delegate.averageFMeasure();
  }
